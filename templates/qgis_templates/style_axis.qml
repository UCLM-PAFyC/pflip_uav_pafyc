...
<qgis version="2.6.0-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="id_c_axis">
  ...
  <customproperties>
    ...
    <property key="labeling/bufferColorB" value="227"/>
    <property key="labeling/bufferColorG" value="206"/>
    <property key="labeling/bufferColorR" value="166"/>
    ...
    <property key="labeling/fieldName" value="concat('axis ',tostring(id_c_axis))"/>
